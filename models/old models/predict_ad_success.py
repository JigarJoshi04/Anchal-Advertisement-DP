...
df1 = pd.read_csv(
    dir + "\\datasets\\predict_ad_success_sample_submission.csv",
    delimiter=",",
    nrows=nRowsRead,
)
...
df2 = pd.read_csv(
    dir + "\\datasets\\predict_ad_success_train.csv", delimiter=",", nrows=nRowsRead
)
...
df3 = pd.read_csv(
    dir + "/datasets/predict_ad_success_test.csv", delimiter=",", nrows=nRowsRead
)
